...
export default function Workshops() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (activeTab === "workshops") {
        const res = await fetch(`${API_URL}/api/collaborations/workshops`, {
  ...
  const handleRegister = async (id) => {
    try {
      ...
      const endpoint =
        activeTab === "workshops"
          ? `${API_URL}/api/collaborations/workshops/${id}/register`
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const endpoint =
        activeTab === "workshops"
          ? `${API_URL}/api/collaborations/workshops`
          : `${API_URL}/api/collaborations/guest-lectures`;
      const res = await fetch(endpoint, {
        method: "POST",
        headers: {
    ...
    <div className="max-w-6xl mx-auto p-3 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-3 sm:px-4 py-2 rounded-lg border whitespace-nowrap capitalize font-medium text-sm sm:text-base transition-colors ${
            activeTab === "workshops"
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex gap-2 sm:gap-3">
                  <div className="p-2 bg-indigo-50 rounded-lg">
                    <Presentation className="text-indigo-600 w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div>
