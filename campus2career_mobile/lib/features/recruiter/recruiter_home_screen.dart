  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async => setState(() => _future = context.read<RecruiterService>().fetchDashboard()),
          ...
          builder: (context, snap) {
            ...
            return ListView(
              ...
              children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(d['companyName']?.toString() ?? 'Company',
                ...
                Row(
                  children: [
                    _stat('Jobs', d['totalJobs'] ?? 0, AppColors.primary),
                    const SizedBox(width: 8),
                    _stat('Applicants', d['totalApplicants'] ?? 0, AppColors.accent),
                    const SizedBox(width: 8),
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        onTap: () => context.push('/recruiter/jobs/post'),
                      ),
                      ...
                      ListTile(
                        ...
                        title: const Text('Recruitment analytics'),
                        trailing: const Icon(Icons.chevron_right),
